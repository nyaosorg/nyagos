...
powershell "$wsh=New-Object -Com WScript.Shell; $sc=$wsh.CreateShortcut([IO.Path]::Combine([Environment]::GetFolderPath('Desktop'),'Nihongo Yet Another GOing Shell.lnk')); $sc.TargetPath='%INSTALLDIR%\nyagos.exe'; $sc.WorkingDirectory='%USERPROFILE%' ; $sc.Description='Nihongo Yet Another GOing Shell'; $sc.HotKey='CTRL+ALT+N' ; $sc.Save();"
